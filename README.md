...
| 2 | 1/16 | A popular spectral graph convolution model, message passing, symmetries and reasoning (Kimon lecturing) | - [Convolutional Neural Networks on Graphs with Fast Localized Spectral Filtering](https://arxiv.org/abs/1606.09375) <br/> - ??  | |
