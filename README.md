...
| 3 | 1/23 | Expressive power, Part 2 | - [The Expressive Power of Graph Neural Networks (Chapter 5.4.2.4, up to 5.4.3.2), included)](https://graph-neural-networks.github.io/static/file/chapter5.pdf)  <br/> - [What graph neural networks cannot learn: depth vs width](https://openreview.net/pdf?id=B1l2bp4YwS)| [Slides](https://github.com/opallab/cs886-winter-2025/blob/main/The_Expressive_Power_of_Graph_Neural_Networks.pdf) | 
