...
| 2 | 1/16 | A popular spectral graph convolution model, message passing, symmetries and reasoning (Kimon lecturing) | - [Convolutional Neural Networks on Graphs with Fast Localized Spectral Filtering](https://arxiv.org/abs/1606.09375) <br/> - [What Can Neural Networks Reason About?](https://arxiv.org/abs/1905.13211)  | |
| 3 | 1/21 | Expressive power, Part 1| - [The Expressive Power of Graph Neural Networks (Chapter 5.3)](https://graph-neural-networks.github.io/static/file/chapter5.pdf) <br/> - [The Expressive Power of Graph Neural Networks (Chapter 5.4, up to 5.4.2.3), included)](https://graph-neural-networks.github.io/static/file/chapter5.pdf) |  |
| 3 | 1/23 | Expressive power, Part 2 | - [The Expressive Power of Graph Neural Networks (Chapter 5.4.2.4, up to 5.4.3.2), included)](https://graph-neural-networks.github.io/static/file/chapter5.pdf)  <br/> - [What graph neural networks cannot learn: depth vs width](https://openreview.net/pdf?id=B1l2bp4YwS)| | 
